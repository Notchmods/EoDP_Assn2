...
avg_no_wheels = {"Bicycle": 2}
avg_seating_capacity = {"Bicycle": 0}
avg_tare_weight = {}
avg_no_occupants = {}
...
def vehicle_df(vehicle_path):
    ...
    - VEHICLE_DAMAGE_LEVEL: Indicates the level of damage to the vehicle.
        Contained value types (after mapping):
            ...
            5: "Extensive (unrepairable)"
    """
    vehicle = pd.read_csv(vehicle_path, usecols=["ACCIDENT_NO", "VEHICLE_ID", "VEHICLE_MODEL", "VEHICLE_BODY_STYLE", "VEHICLE_TYPE_DESC", "LEVEL_OF_DAMAGE",  "NO_OF_WHEELS", "NO_OF_CYLINDERS", "SEATING_CAPACITY", "TARE_WEIGHT", "TOTAL_NO_OCCUPANTS"])
    # For viewing what each column is
